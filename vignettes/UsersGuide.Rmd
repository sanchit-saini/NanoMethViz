...
Modkit can be used to extract site-level modification data modBAM files. The
`modkit extract full` command will output a tab-separated file with the required
columns that can be converted useing the `create_tabix_file()` function.
